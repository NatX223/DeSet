...
const ExploreDatasetPreview = dynamic(() => import("../components/ExploreDatasetPreview"), {
    ssr: false,
  });
  ...
  return (
    <div>
      ...
      <div class="relative hidden h-screen my-4 ml-4 shadow-lg lg:block w-80">
        ...
        <div class="grid grid-cols-1 gap-4 my-4 md:grid-cols-1 lg:grid-cols-2">
                <ExploreDatasetPreview />
            </div>
        </div>
        </div>
      </div>
